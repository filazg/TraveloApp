// Slaze UPUTE_ZA_WEB_STRANICU.md u PDF. Isti postupak kao za portalske upute:
...
const SRC = path.resolve(__dirname, "..", "UPUTE_ZA_WEB_STRANICU.md");
const IMG_DIR = path.resolve(__dirname, "..", "images");
const OUT_PDF = path.resolve(__dirname, "..", "TraveloAPP-Web-Page-API-upute-1.1.pdf");
...
<head>
<meta charset="utf-8">
<title>TraveloAPP Web Page API — Upute za izrađivača web stranice</title>
<style>${css}</style>
</head>
<body>
${resolvedHtml}
