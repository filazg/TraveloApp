...
(async () => {
  ...
  try {
    ...
    await sequelize.query(`ALTER TABLE partners ADD COLUMN IF NOT EXISTS f2_required BOOLEAN NOT NULL DEFAULT false;`);
    console.log("partners.f2_required added (default false)");
  } catch (err) {
