// Slaze PARTNER_API_MANUAL_EN.md u PDF. Isti postupak kao za portalske upute:
...
const SRC = path.resolve(__dirname, "..", "PARTNER_API_MANUAL_EN.md");
const IMG_DIR = path.resolve(__dirname, "..", "images");
const OUT_PDF = path.resolve(__dirname, "..", "TraveloAPP-Partner-API-manual-1.05-EN.pdf");
...
<head>
<meta charset="utf-8">
<title>TraveloAPP Partner API — Partner integration manual</title>
<style>${css}</style>
</head>
<body>
${resolvedHtml}
