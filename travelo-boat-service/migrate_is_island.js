...
(async () => {
  ...
  try {
    ...
    await sequelize.query(`ALTER TABLE tickets_types ADD COLUMN IF NOT EXISTS is_island BOOLEAN DEFAULT FALSE;`);
    await sequelize.query(`ALTER TABLE timetable_prices ADD COLUMN IF NOT EXISTS is_island BOOLEAN DEFAULT FALSE;`);
    console.log("tickets_types + timetable_prices: is_island added");
  } catch (err) {
