// Slaze UPUTE_ZA_PARTNERSKU_PRODAJU.md u PDF. Isti postupak kao za portalske upute:
// marked pretvara markdown u html, Chromium ga ispisuje u PDF.
//
// Pokretanje:  node docs/upute/_alat/build_pdf.cjs
//
// Nastavak .cjs jer partner-sale je ESM projekt ("type": "module"), a skripta
// se sluzi require-om.
const fs = require("fs");
...
const SRC = path.resolve(__dirname, "..", "UPUTE_ZA_PARTNERSKU_PRODAJU.md");
const IMG_DIR = path.resolve(__dirname, "..", "images");
const OUT_PDF = path.resolve(__dirname, "..", "TraveloAPP-Partnerska-prodaja-upute-1.0.pdf");
...
<head>
<meta charset="utf-8">
<title>TraveloAPP Partnerska prodaja — Upute za korisnika</title>
<style>${css}</style>
</head>
<body>
${resolvedHtml}
